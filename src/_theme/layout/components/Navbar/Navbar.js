        ...
        <Container fluid>
          ...
          <Navbar.Collapse id="navbarScroll" className="justify-content-end">
            ...
            <div className="d-flex flex-row justify-content-center ml-5"  >
              <input className="bg-dark text-white" onChange={(e) => setSearach(e.target.value)} width={'200px'} style={{ padding: '4px 20px', alignItems: 'center', borderRadius: '90px' }} type="text" placeholder="Search" aria-label="Search" />
